...
public class FibonacciTaskTraces extends RecursiveTask<Long> {
	...
	public Long compute() {
		...
		if (inputValue == 0L) {
			...
			final FibonacciTaskTraces firstWorker = new FibonacciTaskTraces(
			...
			final FibonacciTaskTraces secondWorker = new FibonacciTaskTraces(
	...
	/**
	 * just simulate a longer running task (with out disturbing the other
	 * threads)
	 */
